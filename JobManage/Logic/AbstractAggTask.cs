...
{
    public abstract class AbstractAggTask : AbstractButton
    {
        ...
        {
            List<string> aggTaskNameList = new List<string>();
            aggTaskNameList = _taskDataList.Select(x => x.TASK_NAME).Distinct().ToList<string>();

            foreach (string task in aggTaskNameList)
            {
                List<string> timeList = new List<string>();
                timeList = _taskDataList.Where(x => x.TASK_NAME == task).Select(x => x.TASK_TIME).ToList<string>();
